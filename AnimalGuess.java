...
public class AnimalGuess {
  ...
  /**
   * Reads in decision tree from a text file
   * 
   * @param filename a string of the name of the file
   * @return DecisionTree reads in a decision tree from user input
   */
  ...
  /**
   * Writes decision tree to a text file
   * 
  ...
  /**
   * Guessing game recursive algorithm
   * 
  ...
  /**
   * Starts guessing game and prompts the user
   * 
   * @param a string of the name of the file you're writing to
   * @return void N/A
   */
